import 'dart:async';
import 'package:registro/widget/chatReceiver_widget.dart';
import 'package:registro/widget/chatSender_widget.dart';
...
class ChatGroupScreen extends StatefulWidget {
  ...
  const ChatGroupScreen({Key? key, required this.username, required this.room})
      : super(key: key);
    ...
    socket.on(
        "room msg",
          ...
          if(data["room"] == widget.room){
            ...
            _senderMessage.add(data["sender"])
          }
        });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(widget.room, style: TextStyle(color: Colors.white),),
      ),
      body: Container(
